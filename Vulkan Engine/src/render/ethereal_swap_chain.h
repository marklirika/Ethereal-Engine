...
namespace ethereal {
    ...
    public:
        ...
        EtherealSwapChain(EtherealDevice& deviceRef, VkExtent2D windowExtent);
        EtherealSwapChain(EtherealDevice& deviceRef, VkExtent2D windowExtent, std::shared_ptr<EtherealSwapChain> previous);
        ~EtherealSwapChain();
        ...
        bool compareSwapFormats(const EtherealSwapChain& swapChain) const { 
